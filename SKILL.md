        ---
        name: "r00-borghei-Claude-Skills--datascience"
        description: >
          🤖 Data Science & AI/ML skill suite derived from borghei/Claude-Skills.
...
- `/anomaly-detect` — Time-series anomaly detection with root-cause attribution and alert tuning
        ...
        ```bash
        # Install this skill
        cp -r . ~/.claude/skills/r00-borghei-Claude-Skills--datascience/

        # In Claude Code
        /read ~/.claude/skills/r00-borghei-Claude-Skills--datascience/SKILL.md
        ```
